...
1. Write code that produces the sum the list `[5,1,4,9,3,2]`.
...
1. Given `A = [2,7,1,3,9,5,6,8,4]` what does the following python code do?  If you're working in a different language you will need to translate to that language.
